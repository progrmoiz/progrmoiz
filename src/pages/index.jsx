...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/moiz-farooq.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I'm Moiz, a software designer and entrepreneur based in Karachi City."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/iammoizfarooq"
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/moizfarooq"
